...
def setup_context7_bridge(mcp: Any, indexer: Any) -> None:
    """
    ...
    def fetch_stack_docs():
        ...
        для подгрузки актуальной документации и сохранения ее в
        `[repoPATH]/.agents/booster/stack_docs.md`.
        """
        ...
        return {
            "instruction": (
                "Для каждой из рекомендованных библиотек: "
                "1) Вызовите mcp_context7_resolve-library-id, "
                "2) Получите доки через mcp_context7_query-docs, "
                "3) Сохраните результат и важные концепции в файл "
